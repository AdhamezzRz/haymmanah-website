      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        ...
        >
          ...
          <div>
            ...
            <p style={{ fontFamily: 'var(--font-role-body)', fontSize: '0.75rem', color: 'rgba(var(--muted-rgb),0.7)', marginTop: '1rem' }}>
              حي المربع، الرياض
            </p>
              ...
              {socials.map(s => (
                <Link
                  ...
                  style={{
                    ...
                    textDecoration: 'none',
                    border: `1px solid ${s.label === 'WA' ? 'rgba(37,211,102,0.3)' : 'rgba(var(--muted-rgb),0.25)'}`,
                    borderRadius: 3,
        ...
        {/* Bottom bar */}
        <div style={{ borderTop: '1px solid rgba(var(--ivory-rgb),0.08)', paddingTop: '1.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
